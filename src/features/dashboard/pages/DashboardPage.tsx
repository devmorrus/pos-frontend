            ...
            {isPrivileged && (
              <div className="min-w-[200px]">
                <select
                  ...
                  className="h-11 w-full rounded-2xl border border-gray-200 bg-white px-4 text-sm text-gray-900 outline-none dark:border-gray-800 dark:bg-gray-955 dark:text-white"
                >
